...
<div class="container">
  <form method="POST" action="../model/act-barang-add.php">
    <div class="row">
      <div class="col-25">
        <label for="fname">Scan Using </label>
      </div>
      <div class="col-75">
        <a href="form-barang.php"><span class="fa fa-check-circle-o"></span> Product Id <br></a>
        <a href="form-barang1.php"><span class="fa fa-circle-o"></span> Principle Id <br></a>
      </div>
    </div>
    <!-- <div class="row">
      <div class="col-25">
    ...
    <!-- <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="fname" name="txtIdPrinciple" placeholder="Your Id Principle..">
      </div>
    </div> -->
    <div class="row">
      <div class="col-25">
        <label for="lname">Product Name</label> <!-- ini ga jadi pake autocomplete -->
      </div>
      <div class="col-75">
        <input type="text" name="txtNama" autocomplete="off" required placeholder="Your Product Name..">
      </div>
    </div>
