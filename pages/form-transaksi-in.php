...
<div class="container">
  <form method="POST" action="../model/act-transaksi-in.php">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="lname" name="txtIdTransaksi" value="<?php echo $row['id_transaksi'];?>" readonly required placeholder="Your Transaction Id..">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="hidden" name="txtIdBarang" value="<?= $row['id_barang'] ?>" readonly>
        <input type="text" name="txtBarang" value="<?php echo $row['nama_barang'];?>" readonly placeholder="Your Product name..">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
